...
{
    for (GLCalendarDateRange *range1 in self.ranges) {
        [self removeRange:range1];
    }
    NSLog(@" The ranges array after deleting all objects is %@",self.ranges);
    [self.ranges addObject:range];
    NSLog(@" The ranges array after adding new object is %@",self.ranges);
